		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comseidornssapui5crud1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comseidornssapui5crud1-display": {
								"semanticObject": "comseidornssapui5crud1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.seidor.ns.sapui5crud1",
									"url": sap.ui.require.toUrl("com/seidor/ns/sapui5crud1")
								}
							}
						}
					}
